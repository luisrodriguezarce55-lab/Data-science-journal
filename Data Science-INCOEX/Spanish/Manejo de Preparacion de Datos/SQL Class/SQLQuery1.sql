---Eliminate a new database but if they exist a one with the same name ---
DROP DATABASE IF EXISTS jardineria;
GO

CREATE DATABASE db_jardineria;
go

USE db_jardineria;
go

--- Create table for oficina---
...
--- Create table for gama_producto---
...
GO
--- Create table for detalle_pedido ---
...
GO
--- Selects for search for all the tables ---
--- Search for the table cliente ---
select * from cliente
--- Search for the table oficina ---
select * from oficina
--- Search for the table empleado ---
select * from empleado
--- Search for the table gama_producto ---
select * from gama_producto
--- Search for the table producto ---
select * from producto
--- Search for the table pedido ---
select * from pedido
--- Search for the table detalle_pedido ---
select * from detalle_pedido
--- Search for the table Pago ---
select * from pago
go

--- return the list codigo_oficina and ciudad of the table oficina
Select codigo_oficina, ciudad from oficina
--- return the list nombre and codigo jefe of the table oficina
Select nombre, codigo_jefe from empleado
--- return the list codigo_oficina and ciudad of the table oficina with the specific situation --- 
select ciudad, telefono from oficina
where pais = 'Japón'
go

---Devuelve un listado con el nombre, apellidos y email de los empleados cuyo---
--- jefe tiene codigo de jefe igual a 7---
select nombre, apellido1,apellido2, email from empleado 
where codigo_jefe=7

--- Devuelve el nombre del puesto, nombre---
--- Apellidos y email del jefe de la empresa---
...
select puesto, nombre, apellido1, apellido2,puesto from empleado
where puesto <> 'Representantes de ventas'

select puesto, nombre, apellido1, apellido2,puesto from empleado
where puesto not like 'representantes de ventas'

-- Datos ---
---Insert of the data of the table oficina---
...
---Insert of the data of the empleado oficina---
...
---Insert of the data of the gama_producto oficina---
...
---Insert of the data of the table cliente---
...
---Insert of the data of the table pedido---
...
---Insert of the data of the table producto---
...
---Insert of the data of the table detalle_pedido---
...
---Insert of the data of the table pago---
